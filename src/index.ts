...
const enteredValue: HTMLInputElement | null = document.querySelector('input[id="enteredValue"]');
const calculateButton: HTMLButtonElement | null = document.querySelector('button[id="calculateButton"]');
const calculatedValue: HTMLDivElement | null = document.querySelector('div[id="calculatedValue"]');
